...
export default function Privacy() {
  const today =
    typeof window !== "undefined"
      ...
      : "2025-01-01"; // fallback zodat Vercel niet crasht

  return (
    <div className="min-h-screen bg-white">
      {/* Als je een Header hebt, haal de comment weg */}
      {/* <Header /> */}
      ...
      <main className="max-w-4xl mx-auto px-6 py-10">
        ...
        <p className="text-gray-700">
          Creative Tools ("we", "us", "our") respects your privacy and is
        ...
        <p className="text-gray-700">
          We collect personal information you provide directly (for example,
          when you register, contact us, or leave feedback). This may include
          your name, email address, and content you submit.
        </p>
        ...
        <p className="text-gray-700">
          ...
          inquiries, and communicate about updates and offers. We do not sell
          your personal data.
        </p>
        ...
        <p className="mt-8 text-gray-600">
          ...
          <Link href="/" legacyBehavior>
            <a className="text-[#7FB3FF]">home</a>
          </Link>
          .
        </p>
      </main>
